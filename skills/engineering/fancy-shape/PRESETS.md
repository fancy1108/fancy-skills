# Clutch Design presets (snapshot)

Brand looks shipped in Clutch **Design mode**. Fancy Orient/Shape does not invent a fourth catalog.
If a Clutch checkout is on disk, after they pick an id, read `services/orchestrator/src/design/presets/<id>.md` (or `.spec.json`) for tokens.
In chat, recommend **three** rows that fit this product's Pitch — do not paste this whole table.

| id | Name | One line |
| --- | --- | --- |
| `clutch` | Clutch | Built-in Clutch design system — clean developer-tool aesthetic |
...
| `dell-1996` | Dell (1996) | Catalog-era enterprise web. Literal black page frame, flat color-block ribbon cards, chunky Helvetica-Black titles over Times Roman body |
...
| `nintendo-2001` | Nintendo.com (2001) | Y2K console chrome web. Brushed-periwinkle beveled metal panels, halftone-dotted carbon nav glowing amber, outlined Arial-Black box-art wordmarks |
...
| `slack` | Slack | Team communication platform. Vibrant multi-color sidebar, clean messaging UI |
